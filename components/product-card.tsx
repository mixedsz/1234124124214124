...
export function ProductCard({ package_, tags = ['QBCORE', 'QBOX', 'ESX'] }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group block bg-[#1c1c1c] rounded-xl overflow-hidden border border-neutral-800 hover:border-blue-500/50 transition-all duration-300 hover:scale-[1.03]"
    >
      {/* Image */}
